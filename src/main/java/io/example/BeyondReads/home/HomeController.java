package io.example.BeyondReads.home;

import io.example.BeyondReads.user.BooksByUser;
import io.example.BeyondReads.user.BooksByUserRepository;
...
public class HomeController {
    ...
    //if user is not login, we show index. If login we show home
    public String home(@AuthenticationPrincipal OAuth2User principal, Model model) {
        ...
        //distinct() - not show the book more than once in the home page if user reads multiple times
